...
-1002072462276: [-1002131940541],
 ...
 #Modern Elliot
   -1002060206996:[-1001998466958],
 #US30 Kingdom
    -1002146564800:[-1002088207771],
 #Superlative Gold
    -1001900050181:[-1002061618924],
 #Gold Killer 
 ...
 #Mike Syndicate
  -1002093810166:[-1002026321203],
 #Time2Trade
   -1001959852937:[-1002076836030],
 #NAS 100 PRO
     -1001825958354 :[-1002102118137],
#SMC PREMIUM
   -1002109463500:[-1002055894160],
     #Mega FX
  -1001609208127:[-1002122596670],
 #PROPFRIM TRADERS 
   -1001953863161:[-1002002911906],
 #Found Xations
      -1001939711079:[ -1002235061840],

 #ZA GOLD SCALPER
    -1002076434259:[-1002023473272],

# FOREX HINTS 
   -1002048707667:[-1002117688852],

# WANDA
    -1001828948288:[-1002021715309],

# TRADING WITH MASTER
    -1001886456713:[-1002137778091],
    
 # ALEX
    -1002049387749:[-1002082429891],

#SMC FINESSE
    -1002047165373:[-1002092099877],

#ELLIOT WAVE 
    -1001613495553:[ -1002061385823],
   
 #FOREX GURU
    -1002052510983:[-1002051298823],

#15M SIGNALS
    -1002098185924:[-1002120753195],

#25 PIPS SCALPING
    -1002082857983:[-1002045644238],

#VIP US30 PRO 
    -1002145060300:[-1002043161677],

#FX GOLD SIGNALS
    -1002121618150:[-1002019115733],

#LA CAPSULE 
    -1001962400907:[-1002045313573],
